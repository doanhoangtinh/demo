...
public class RoleController {
	...
	@CrossOrigin
    @PostMapping
	public ResponseEntity<RoleResponseModel> createRole(@RequestBody @Valid RoleRequestModel roleRequestModel, BindingResult bindingResult) {
	...
	public ResponseEntity<List<RoleResponseModel>> getRoles() {
		List<RoleDTO> roleDTOs  = roleService.getRoles();
	 	...
	 	List<RoleResponseModel> roleResponseModels = mapper.map(roleDTOs, new TypeToken<List<RoleResponseModel>>(){}.getType());
