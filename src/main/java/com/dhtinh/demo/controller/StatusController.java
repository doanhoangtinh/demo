...
public class StatusController {
	...
	@CrossOrigin
    @PostMapping
	public ResponseEntity<StatusResponseModel> createStatus(@RequestBody @Valid StatusRequestModel statusRequestModel, BindingResult bindingResult) {
	...
	public ResponseEntity<List<StatusResponseModel>> getStatuss() {
		List<StatusDTO> statusDTOs  = statusService.getStatuses();
	 	...
	 	List<StatusResponseModel> statusResponseModels = mapper.map(statusDTOs, new TypeToken<List<StatusResponseModel>>(){}.getType());
